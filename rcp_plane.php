...
if (isset($_POST['submit'])) {
    ...
    $sql_1 = $dbh->prepare('SELECT * FROM stock WHERE id = :item_1 LIMIT 1');
    ...
    $sql_2 = $dbh->prepare('SELECT * FROM stock WHERE id = :item_2 LIMIT 1');
    ...
    $sql_3 = $dbh->prepare('SELECT * FROM stock WHERE id = :item_3 LIMIT 1');
    ...
    $sql_4 = $dbh->prepare('SELECT * FROM stock WHERE id = :item_4 LIMIT 1');
...
<form action="rcp_plane.php" method="post" id="add_course">
    ...
    ?>
        ...
        <?php
        $sql = $dbh->prepare('SELECT * FROM `stock` ');
                $sql->execute();
                while ($row = $sql->fetch()) {
                    ?>
